...
class Contact extends Component{
    ...
    validate = (firstname, lastname, telnum, email) => {
        ...
        if(this.state.touched.firstname && firstname.length < 3){
            ...
            errors.firstname = 'What a Name you have !!!!'
        }
        ...
        if(this.state.touched.lastname && lastname.length < 3){
            ...
            errors.lastname = 'What a Name you have !!!!'
        }
            ...
            <div className="container">
                <div className='row'>
                    <Breadcrumb>
                        ...
                        <BreadcrumbItem active><Link to='/contact-us'>Contact Us</Link></BreadcrumbItem>
                    </Breadcrumb>
                    ...
                    <div className='col-12 col-md-9'>
                        <Form onSubmit={this.SubmitHandler}>
                            ...
                            <FormGroup row>
                                ...
                                <div className='col-md-10'>
                                    <Input type='textarea' id='message' name='message' row='12' value={this.state.message} onChange={this.ChangeHandler}/>
                                </div>
                            </FormGroup>
